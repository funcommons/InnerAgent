...
import com.inneragent.agent.kernel.AgentKernelResource;
import com.inneragent.agent.kernel.AgentKernelSpec;
import com.inneragent.agent.kernel.AgentKernelToolkitResources;
import com.inneragent.agent.kernel.AgentKernelToolRegistry;
import com.inneragent.agent.kernel.AgentSessionSerialGate;
import com.inneragent.agent.kernel.AgentScopeHarnessFactory;
import com.inneragent.agent.kernel.DefaultAgentScopeHarnessInvoker;
import com.inneragent.agent.kernel.HarnessLeaseCache;
...
import com.inneragent.agent.state.AgentScopeShutdownRecoveryBridge;
import com.inneragent.agent.state.AgentStatePreflight;
import com.inneragent.agent.state.FailClosedAgentStateStore;
    ...
    void localYamlBindsAndWiresTheRealSpringRuntime() {
        ...
        new ApplicationContextRunner()
                ...
                .withUserConfiguration(
                        com.inneragent.platform.config.AgentScopeRuntimeConfiguration.class,
                ...
                .run(context -> {
                    ...
                    assertThat(properties.getState().getTableName()).isEqualTo("ia_agent_state");
