package com.inneragent.platform.service.ai.dashscope;
...
import com.inneragent.platform.enums.ai.AiModelTypeEnum;
import com.inneragent.platform.service.storage.LocalMediaPathUtils;
...
public class DashScopeGenerationSupport {
    ...
    private BinaryResource loadLocalMedia(String sourceUrl) throws IOException {
        String relativePath = LocalMediaPathUtils.extractRelativePath(sourceUrl);
