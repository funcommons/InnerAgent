export default {
  ...
  ia: {
    adminEmbed: {
      title: 'InnerAgent 管理台',
      hint: '管理能力(Skill / 知识库 / MCP / Agent 定义 / 模型 / 用量 / 审计)属 InnerAgent 域,由 InnerAgent 管理台提供;管理员账号 admin / Admin#12345(独立会话,不做 SSO)。',
      'new-tab': '新窗口打开',
      'frame-title': 'InnerAgent 管理台',
    },
    overview: {
      ...
      'col-guide': '接入指南章节',
      'col-code': 'DEMO 代码位置',
      'coverage-title': '中台能力 ↔ DEMO 体验入口',
      'coverage-subtitle': '能力覆盖盘点:每项中台能力都有可体验入口,或标注「内核保障(E2E/IT 覆盖)」;管理台各页在 /ia/admin 嵌入页内体验',
      'col-capability': '中台能力',
      'col-entry': '在哪体验',
      'col-note': '口径 / 说明',
