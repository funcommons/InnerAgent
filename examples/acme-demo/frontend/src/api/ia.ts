...
/**
 * InnerAgent 管理台(e2e 网关形态:web dist 静态 + /ia 反代)。
 * 架构口径:Skill/知识库/MCP/Agent 定义属 InnerAgent 域能力,管理 UI 由
 * InnerAgent 前端提供;宿主 APP 只提供 APP 内部 MCP(业务工具桥)。
 */
export const IA_ADMIN_CONSOLE_URL = 'http://localhost:18081'
