export default {
  ...
  ia: {
    agentAdmin: {
      title: 'Agent Admin',
      subtitle: 'Create, configure, enable/disable InnerAgent agent definitions; changes apply immediately in the embedded chat',
      create: 'New Agent',
      edit: 'Edit',
      cancel: 'Cancel',
      save: 'Save',
      'drawer-create': 'New agent definition',
      'drawer-edit': 'Edit agent definition',
      'kind-main': 'Main agent',
      'kind-sub': 'Sub agent',
      'col-name': 'Name',
      'col-kind': 'Kind',
      'col-tools': 'Tool whitelist',
      'col-enabled': 'Status',
      'col-actions': 'Actions',
      enabled: 'Enabled',
      disabled: 'Disabled',
      'field-model': 'Dialogue model',
      'field-tools': 'Tool whitelist',
      'field-sub-agents': 'Delegatable sub agents',
      'field-system-prompt': 'System prompt (persona)',
      'field-greeting': 'Greeting',
      'ph-agent-type': 'lowercase letters/digits/hyphens, e.g. trouble-reporter',
      'ph-name': 'Display name',
      'ph-model': 'Empty = follow runtime default model',
      'ph-tools': 'None selected = this agent gets no tools',
      'ph-sub-agents': 'Sub agents this agent may delegate to',
      'ph-system-prompt': 'Define persona, boundaries and output style…',
      'keep-blank': '(keep blank = keep current value)',
      hint: 'Configuration is written to the InnerAgent admin surface via the host backend (bundle overwrite); the kernel resolves definitions data-driven, so saves apply immediately.',
      'create-ok': 'Agent created',
      'update-ok': 'Configuration saved',
      'save-errors': 'Saved with {count} error(s), please review the definition',
    },
    overview: {
