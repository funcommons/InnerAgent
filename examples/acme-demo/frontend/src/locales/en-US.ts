export default {
  ...
  ia: {
    ...
    overview: {
      ...
      'coverage-title': 'Platform capabilities ↔ demo entry points',
      'coverage-subtitle': 'Capability coverage map: every platform capability has a hands-on demo entry, or is marked as kernel-guaranteed (covered by E2E/IT); admin console pages live inside the /ia/admin embed',
      'col-capability': 'Capability',
      'col-entry': 'Where to try',
      'col-note': 'Notes',
